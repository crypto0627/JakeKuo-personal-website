...
export const featuredProjects: Project[] = [
  ...
  },
  {
    id: 2,
    title: "AuthenPay",
    description: "A wallet-less USDC payment across multiple chains—delivering smooth, secure, seamless Web3 payments.",
    tags: ["2025 Ethglobal Taipei", "Circle CCTP-V2", "USDC payment", "EIP-4337", "Alchemy"],
  ...
  {
    id: 4,
    title: "Behind-the-Meter Energy Storage System",
    description: "Solar-integrated Energy Storage System uses MCP and Claude 3.7 to analyze energy data, optimize electricity usage, and reduce peak demand costs through intelligent storage management.",
    tags: ["Energy Storage System", "LLM + Model Context Protocol", "Next.js", "MongoDB", "Postgres", "Prisma ORM"],
    image: "/ess-logo.png?height=25&width=25",
    github: "#",
    demo: "https://www.fortune-ess.com.tw/behind-ess/en/main/dashboard/",
  },
]
...
export const allProjects: Project[] = [
  ...featuredProjects,
  {
    ...
    description: "A responsive e-commerce web app for selling Luwei, supporting both mobile and desktop users with online ordering and payment features.",
    tags: ["Next.js", "Tailwindcss", "Zustand", "Cloudflare hono d1 kv", "Drizzle ORM", "PWA"],
  ...
  },
  {
    ...
    description: "Huacheng Electric advances localized energy storage solutions to lower costs and boost efficiency, supporting green industry and energy transition through strategic partnerships and large-scale renewable energy projects.",
    tags: ["HTML", "CSS", "JavaScript", "Nginx", "Docker Compose", "Cloudflare Proxy"],
